...
const COMMANDS: CommandDefinition[] = [
  ...
  },
  {
    ...
    prompt: "Redacta una propuesta SDD. PRIMERO: mostra al usuario el resumen del discovery y preguntale: '¿Este analisis refleja bien el estado del proyecto? ¿Falta algo que quieras agregar?' Iter hasta que diga 'si, esta bien'. DESPUES, empeza la propuesta. PROPONE cada seccion basandote en el codigo y la estructura del proyecto que ya relevaste. No preguntes en blanco. Por ejemplo, en 'problema' mostrale algo como 'Segun lo que vi en el codigo, el proyecto actualmente hace X pero no Y. ¿Es correcto?' En 'alcance' proponele los modulos/archivos que identificaste como afectados. En 'riesgos' mostra los que ya detectaste en el discovery. Para cada seccion: proponé, preguntá '¿Te parece bien? ¿Queres cambiar algo?', iterá hasta que confirme. Al final mostra el resumen completo y preguntá '¿Queres modificar, agregar o quitar algo?' hasta que diga 'listo' o 'esta bien'.",
  },
  {
    step: "04-spec",
    command: "pi:04-spec",
    ...
    prompt: "PRIMERO: mostrale al usuario la propuesta actual de docs/sdd/ y preguntale: '¿Esta propuesta esta completa para vos? ¿Queres modificar algo o agregar algo mas?' Si el usuario quiere cambios, ayudalo a modificar la propuesta iterando hasta que diga 'listo' o 'dale'. RECIEN DESPUES de su confirmacion, empeza a escribir la especificacion SDD. Para cada seccion usa el termino en ingles con su traduccion entre parentesis, ej: MUST (obligatorio), SHOULD (deseable), Given/When/Then (Dado/Cuando/Entonces). NO preguntes en blanco. PROPONE ejemplos concretos basados en el codigo, la estructura y las funcionalidades existentes del proyecto que ya relevaste. Mostra cada propuesta y pregunta: '¿Agregamos este? ¿Queres modificarlo o proponer otro?' Iter hasta que el usuario confirme. Orden: 1) requisitos MUST, 2) requisitos SHOULD, 3) escenarios Given/When/Then.",
  },
  {
    step: "05-design",
